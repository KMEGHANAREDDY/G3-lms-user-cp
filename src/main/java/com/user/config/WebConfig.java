 ...
 * .allowedOrigins("http://15.168.114.125:3000","http://localhost:3000")
 * .allowedOrigins("*")// Allow requests from this origin .allowedMethods("GET",
 * "POST", "PUT", "DELETE", "OPTIONS") // Allow common HTTP methods
